...
#include "node_atc18_invtd_zn.h"

//register to node factory
std::string Node_ATC18_INVTD_ZN::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_INVTD_ZN",Node_ATC18_INVTD_ZN::create_function);
std::string Node_ATC18_INVTD_ZN::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_INVTD","ZN");

Node_ATC18_INVTD_ZN::Node_ATC18_INVTD_ZN(const char *name) : Node(name, 2){
    port_map_vector.push_back("I"); //0
    port_map_vector.push_back("EN"); //1

}

Node_ATC18_INVTD_ZN::~Node_ATC18_INVTD_ZN()
{
}

std::string Node_ATC18_INVTD_ZN::get_input_name(int i)
{
    switch(i){
        case(0): return("I");
        case(1): return("EN");
...
int Node_ATC18_INVTD_ZN::get_value(int run)
{
...
std::string Node_ATC18_INVTD_ZN::get_formula()
{
//define some helpers, makes it easier to write function
