...
#include "node_atc18_aoi322p_zn.h"

//register to node factory
std::string Node_ATC18_AOI322P_ZN::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_AOI322P_ZN",Node_ATC18_AOI322P_ZN::create_function);
std::string Node_ATC18_AOI322P_ZN::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_AOI322P","ZN");

Node_ATC18_AOI322P_ZN::Node_ATC18_AOI322P_ZN(const char *name) : Node(name, 7){
...
Node_ATC18_AOI322P_ZN::~Node_ATC18_AOI322P_ZN()
{
}

std::string Node_ATC18_AOI322P_ZN::get_input_name(int i)
{
    switch(i){
        case(0): return("B1");
        case(1): return("A1");
...
int Node_ATC18_AOI322P_ZN::get_value(int run)
{
...
std::string Node_ATC18_AOI322P_ZN::get_formula()
{
//define some helpers, makes it easier to write function
