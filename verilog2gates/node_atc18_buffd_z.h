...
#ifndef NODE_ATC18_BUFFD_Z_H
#define NODE_ATC18_BUFFD_Z_H
#include "node.h"

class Node_ATC18_BUFFD_Z : public Node
{
public:
    Node_ATC18_BUFFD_Z(const char *name = "?");
    ~Node_ATC18_BUFFD_Z();

    static Node* create_function(const char *name){ return new Node_ATC18_BUFFD_Z(name); }
