...
#include "node_atc18_mi02d_zn.h"

//register to node factory
std::string Node_ATC18_MI02D_ZN::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_MI02D_ZN",Node_ATC18_MI02D_ZN::create_function);
std::string Node_ATC18_MI02D_ZN::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_MI02D","ZN");

Node_ATC18_MI02D_ZN::Node_ATC18_MI02D_ZN(const char *name) : Node(name, 3){
...
Node_ATC18_MI02D_ZN::~Node_ATC18_MI02D_ZN()
{
}

std::string Node_ATC18_MI02D_ZN::get_input_name(int i)
{
    switch(i){
        case(0): return("S");
        case(1): return("I0");
...
int Node_ATC18_MI02D_ZN::get_value(int run)
{
...
std::string Node_ATC18_MI02D_ZN::get_formula()
{
//define some helpers, makes it easier to write function
