 ...
 *                                                                         *
 ***************************************************************************/
 ///this file was automatically created by D2 on Thu Jan 24 13:58:23 2008

#include "node_atc18_aoi2222d_zn.h"

//register to node factory
std::string Node_ATC18_AOI2222D_ZN::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_AOI2222D_ZN",Node_ATC18_AOI2222D_ZN::create_function);
std::string Node_ATC18_AOI2222D_ZN::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_AOI2222D","ZN");

Node_ATC18_AOI2222D_ZN::Node_ATC18_AOI2222D_ZN(const char *name) : Node(name, 8){
...
Node_ATC18_AOI2222D_ZN::~Node_ATC18_AOI2222D_ZN()
{
}

std::string Node_ATC18_AOI2222D_ZN::get_input_name(int i)
{
    switch(i){
        case(0): return("D2");
        case(1): return("B1");
...
int Node_ATC18_AOI2222D_ZN::get_value(int run)
{
...
std::string Node_ATC18_AOI2222D_ZN::get_formula()
{
//define some helpers, makes it easier to write function
