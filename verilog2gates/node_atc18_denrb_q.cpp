...
#include "node_atc18_denrb_q.h"

//register to node factory
std::string Node_ATC18_DENRB_Q::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_DENRB_Q",Node_ATC18_DENRB_Q::create_function);
std::string Node_ATC18_DENRB_Q::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_DENRB","Q");

Node_ATC18_DENRB_Q::Node_ATC18_DENRB_Q(const char *name) : Node(name, 3){
...
Node_ATC18_DENRB_Q::~Node_ATC18_DENRB_Q()
{
}

std::string Node_ATC18_DENRB_Q::get_input_name(int i)
{
    switch(i){
        case(0): return("CP");
        case(1): return("ENN");
...
int Node_ATC18_DENRB_Q::evaluate()
{
...
Node *Node_ATC18_DENRB_Q::get_ff_input_node()
{
...
std::string Node_ATC18_DENRB_Q::get_formula()
{
