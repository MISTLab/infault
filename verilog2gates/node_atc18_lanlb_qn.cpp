...
#include "node_atc18_lanlb_qn.h"

//register to node factory
std::string Node_ATC18_LANLB_QN::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_LANLB_QN",Node_ATC18_LANLB_QN::create_function);
std::string Node_ATC18_LANLB_QN::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_LANLB","QN");

Node_ATC18_LANLB_QN::Node_ATC18_LANLB_QN(const char *name) : Node(name, 2){
    port_map_vector.push_back("D"); //0
    port_map_vector.push_back("EN"); //1

}

Node_ATC18_LANLB_QN::~Node_ATC18_LANLB_QN()
{
}

std::string Node_ATC18_LANLB_QN::get_input_name(int i)
{
    switch(i){
        case(0): return("D");
        case(1): return("EN");
...
int Node_ATC18_LANLB_QN::evaluate()
{
...
Node *Node_ATC18_LANLB_QN::get_ff_input_node()
{
...
std::string Node_ATC18_LANLB_QN::get_formula()
{
	return std::string(get_name());
}

int Node_ATC18_LANLB_QN::get_value(int run)
{
    return !value;
}
