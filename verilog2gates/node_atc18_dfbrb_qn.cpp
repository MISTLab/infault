...
#include "node_atc18_dfbrb_qn.h"

//register to node factory
std::string Node_ATC18_DFBRB_QN::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_DFBRB_QN",Node_ATC18_DFBRB_QN::create_function);
std::string Node_ATC18_DFBRB_QN::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_DFBRB","QN");

Node_ATC18_DFBRB_QN::Node_ATC18_DFBRB_QN(const char *name) : Node(name, 4){
...
Node_ATC18_DFBRB_QN::~Node_ATC18_DFBRB_QN()
{
}

std::string Node_ATC18_DFBRB_QN::get_input_name(int i)
{
    switch(i){
        case(0): return("CP");
        case(1): return("D");
...
int Node_ATC18_DFBRB_QN::evaluate()
{
...
Node *Node_ATC18_DFBRB_QN::get_ff_input_node()
{
...
std::string Node_ATC18_DFBRB_QN::get_formula()
{
	return std::string(get_name());
}

int Node_ATC18_DFBRB_QN::get_value(int run)
{
    return !value;
}
