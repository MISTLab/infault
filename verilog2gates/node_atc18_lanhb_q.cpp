...
#include "node_atc18_lanhb_q.h"

//register to node factory
std::string Node_ATC18_LANHB_Q::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_LANHB_Q",Node_ATC18_LANHB_Q::create_function);
std::string Node_ATC18_LANHB_Q::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_LANHB","Q");

Node_ATC18_LANHB_Q::Node_ATC18_LANHB_Q(const char *name) : Node(name, 2){
    port_map_vector.push_back("D"); //0
    port_map_vector.push_back("E"); //1

}

Node_ATC18_LANHB_Q::~Node_ATC18_LANHB_Q()
{
}

std::string Node_ATC18_LANHB_Q::get_input_name(int i)
{
    switch(i){
        case(0): return("D");
        case(1): return("E");
...
int Node_ATC18_LANHB_Q::evaluate()
{
...
Node *Node_ATC18_LANHB_Q::get_ff_input_node()
{
...
std::string Node_ATC18_LANHB_Q::get_formula()
{
