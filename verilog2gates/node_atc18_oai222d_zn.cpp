 ...
 *                                                                         *
 ***************************************************************************/
 ///this file was automatically created by C2 on Thu Jan 24 13:58:28 2008

#include "node_atc18_oai222d_zn.h"

//register to node factory
std::string Node_ATC18_OAI222D_ZN::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_OAI222D_ZN",Node_ATC18_OAI222D_ZN::create_function);
std::string Node_ATC18_OAI222D_ZN::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_OAI222D","ZN");

Node_ATC18_OAI222D_ZN::Node_ATC18_OAI222D_ZN(const char *name) : Node(name, 6){
...
Node_ATC18_OAI222D_ZN::~Node_ATC18_OAI222D_ZN()
{
}

std::string Node_ATC18_OAI222D_ZN::get_input_name(int i)
{
    switch(i){
        case(0): return("B1");
        case(1): return("A1");
...
int Node_ATC18_OAI222D_ZN::get_value(int run)
{
...
std::string Node_ATC18_OAI222D_ZN::get_formula()
{
//define some helpers, makes it easier to write function
