...
#include "node_atc18_sdcrb_qn.h"

//register to node factory
std::string Node_ATC18_SDCRB_QN::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_SDCRB_QN",Node_ATC18_SDCRB_QN::create_function);
std::string Node_ATC18_SDCRB_QN::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_SDCRB","QN");

Node_ATC18_SDCRB_QN::Node_ATC18_SDCRB_QN(const char *name) : Node(name, 3){
...
Node_ATC18_SDCRB_QN::~Node_ATC18_SDCRB_QN()
{
}

std::string Node_ATC18_SDCRB_QN::get_input_name(int i)
{
    switch(i){
        case(0): return("CP");
        case(1): return("D");
...
int Node_ATC18_SDCRB_QN::evaluate()
{
...
Node *Node_ATC18_SDCRB_QN::get_ff_input_node()
{
...
std::string Node_ATC18_SDCRB_QN::get_formula()
{
	return std::string(get_name());
}

int Node_ATC18_SDCRB_QN::get_value(int run)
{
    return !value;
}
