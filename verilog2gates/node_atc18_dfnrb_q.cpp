...
#include "node_atc18_dfnrb_q.h"

//register to node factory
std::string Node_ATC18_DFNRB_Q::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_DFNRB_Q",Node_ATC18_DFNRB_Q::create_function);
std::string Node_ATC18_DFNRB_Q::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_DFNRB","Q");

Node_ATC18_DFNRB_Q::Node_ATC18_DFNRB_Q(const char *name) : Node(name, 2){
    port_map_vector.push_back("CP"); //0
    port_map_vector.push_back("D"); //1

}

Node_ATC18_DFNRB_Q::~Node_ATC18_DFNRB_Q()
{
}

std::string Node_ATC18_DFNRB_Q::get_input_name(int i)
{
    switch(i){
        case(0): return("CP");
        case(1): return("D");
...
int Node_ATC18_DFNRB_Q::evaluate()
{
...
Node *Node_ATC18_DFNRB_Q::get_ff_input_node()
{
...
std::string Node_ATC18_DFNRB_Q::get_formula()
{
