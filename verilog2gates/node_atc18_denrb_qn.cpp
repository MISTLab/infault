...
#include "node_atc18_denrb_qn.h"

//register to node factory
std::string Node_ATC18_DENRB_QN::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_DENRB_QN",Node_ATC18_DENRB_QN::create_function);
std::string Node_ATC18_DENRB_QN::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_DENRB","QN");

Node_ATC18_DENRB_QN::Node_ATC18_DENRB_QN(const char *name) : Node(name, 3){
...
Node_ATC18_DENRB_QN::~Node_ATC18_DENRB_QN()
{
}

std::string Node_ATC18_DENRB_QN::get_input_name(int i)
{
    switch(i){
        case(0): return("CP");
        case(1): return("ENN");
...
int Node_ATC18_DENRB_QN::evaluate()
{
//define some helpers, makes it easier to write function
    ...
    int run = last_eval++;
    last_run_value = !((1?(1?(ENN?Q:D):0):1));
    return last_run_value;
}

Node *Node_ATC18_DENRB_QN::get_ff_input_node()
{
...
int Node_ATC18_DENRB_QN::get_value(int run)
{
    return !value;
}
