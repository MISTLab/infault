...
#include "node_atc18_mx04p_z.h"

//register to node factory
std::string Node_ATC18_MX04P_Z::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_MX04P_Z",Node_ATC18_MX04P_Z::create_function);
std::string Node_ATC18_MX04P_Z::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_MX04P","Z");

Node_ATC18_MX04P_Z::Node_ATC18_MX04P_Z(const char *name) : Node(name, 6){
...
Node_ATC18_MX04P_Z::~Node_ATC18_MX04P_Z()
{
}

std::string Node_ATC18_MX04P_Z::get_input_name(int i)
{
    switch(i){
        case(0): return("S1");
        case(1): return("I2");
...
int Node_ATC18_MX04P_Z::get_value(int run)
{
...
std::string Node_ATC18_MX04P_Z::get_formula()
{
//define some helpers, makes it easier to write function
