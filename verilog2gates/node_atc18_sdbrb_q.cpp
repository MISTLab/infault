...
#include "node_atc18_sdbrb_q.h"

//register to node factory
std::string Node_ATC18_SDBRB_Q::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_SDBRB_Q",Node_ATC18_SDBRB_Q::create_function);
std::string Node_ATC18_SDBRB_Q::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_SDBRB","Q");

Node_ATC18_SDBRB_Q::Node_ATC18_SDBRB_Q(const char *name) : Node(name, 4){
...
Node_ATC18_SDBRB_Q::~Node_ATC18_SDBRB_Q()
{
}

std::string Node_ATC18_SDBRB_Q::get_input_name(int i)
{
    switch(i){
        case(0): return("CDN");
        case(1): return("CP");
...
int Node_ATC18_SDBRB_Q::evaluate()
{
...
Node *Node_ATC18_SDBRB_Q::get_ff_input_node()
{
...
std::string Node_ATC18_SDBRB_Q::get_formula()
{
