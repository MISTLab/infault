...
#include "node_atc18_labhb_q.h"

//register to node factory
std::string Node_ATC18_LABHB_Q::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_LABHB_Q",Node_ATC18_LABHB_Q::create_function);
std::string Node_ATC18_LABHB_Q::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_LABHB","Q");

Node_ATC18_LABHB_Q::Node_ATC18_LABHB_Q(const char *name) : Node(name, 4){
...
Node_ATC18_LABHB_Q::~Node_ATC18_LABHB_Q()
{
}

std::string Node_ATC18_LABHB_Q::get_input_name(int i)
{
    switch(i){
        case(0): return("D");
        case(1): return("CDN");
...
int Node_ATC18_LABHB_Q::evaluate()
{
...
Node *Node_ATC18_LABHB_Q::get_ff_input_node()
{
...
std::string Node_ATC18_LABHB_Q::get_formula()
{
