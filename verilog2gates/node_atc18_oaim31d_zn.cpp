 ...
 *                                                                         *
 ***************************************************************************/
 ///this file was automatically created by B3 on Thu Jan 24 13:58:29 2008

#include "node_atc18_oaim31d_zn.h"

//register to node factory
std::string Node_ATC18_OAIM31D_ZN::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_OAIM31D_ZN",Node_ATC18_OAIM31D_ZN::create_function);
std::string Node_ATC18_OAIM31D_ZN::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_OAIM31D","ZN");

Node_ATC18_OAIM31D_ZN::Node_ATC18_OAIM31D_ZN(const char *name) : Node(name, 4){
...
Node_ATC18_OAIM31D_ZN::~Node_ATC18_OAIM31D_ZN()
{
}

std::string Node_ATC18_OAIM31D_ZN::get_input_name(int i)
{
    switch(i){
        case(0): return("A");
        case(1): return("B3");
...
int Node_ATC18_OAIM31D_ZN::get_value(int run)
{
...
std::string Node_ATC18_OAIM31D_ZN::get_formula()
{
//define some helpers, makes it easier to write function
