...
#ifndef NODE_ATC18_DENRB_QN_H
#define NODE_ATC18_DENRB_QN_H
#include "node.h"

class Node_ATC18_DENRB_QN : public Node
{
public:
    Node_ATC18_DENRB_QN(const char *name = "?");
    ~Node_ATC18_DENRB_QN();

    static Node* create_function(const char *name){ return new Node_ATC18_DENRB_QN(name); }
