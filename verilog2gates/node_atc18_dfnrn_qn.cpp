...
#include "node_atc18_dfnrn_qn.h"

//register to node factory
std::string Node_ATC18_DFNRN_QN::node_factory_dummy = Node_factory<Node>::register_create_function("ATC18_DFNRN_QN",Node_ATC18_DFNRN_QN::create_function);
std::string Node_ATC18_DFNRN_QN::node_factory_dummy2 = Node_factory<Node>::register_output("ATC18_DFNRN","QN");

Node_ATC18_DFNRN_QN::Node_ATC18_DFNRN_QN(const char *name) : Node(name, 2){
    port_map_vector.push_back("CP"); //0
    port_map_vector.push_back("D"); //1

}

Node_ATC18_DFNRN_QN::~Node_ATC18_DFNRN_QN()
{
}

std::string Node_ATC18_DFNRN_QN::get_input_name(int i)
{
    switch(i){
        case(0): return("CP");
        case(1): return("D");
...
int Node_ATC18_DFNRN_QN::evaluate()
{
...
Node *Node_ATC18_DFNRN_QN::get_ff_input_node()
{
...
std::string Node_ATC18_DFNRN_QN::get_formula()
{
	return std::string(get_name());
}

int Node_ATC18_DFNRN_QN::get_value(int run)
{
    return !value;
}
