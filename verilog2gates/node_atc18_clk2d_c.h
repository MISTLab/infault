...
#ifndef NODE_ATC18_CLK2D_C_H
#define NODE_ATC18_CLK2D_C_H
#include "node.h"

class Node_ATC18_CLK2D_C : public Node
{
public:
    Node_ATC18_CLK2D_C(const char *name = "?");
    ~Node_ATC18_CLK2D_C();

    static Node* create_function(const char *name){ return new Node_ATC18_CLK2D_C(name); }
